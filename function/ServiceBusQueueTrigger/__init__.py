...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="techconfadmin@techconf-dbserver", password="Abcd@1234", host="techconf-dbserver.postgres.database.azure.com")
